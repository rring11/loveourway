...
ini_set('display_errors', 1);
	 ...
	 */
print("*");
	require('../httpclient-2016-05-02/http.php');
print("*");
...
print("*");
	...
	$client->client_id = 'CmX9aiFjM1lcmGUTAwiP75PuB';
	$application_line = __LINE__;
	$client->client_secret = 'BOv7DVpx1Qg91lpm94KXAbqrRjRDQu8n2wCLiXynL8SSmdAuph';
